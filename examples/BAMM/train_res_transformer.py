...
if __name__ == '__main__':
    ...
    # Added for motion_clip - line 128-134
    res_transformer = load_res_model(res_opt)
    ...
    # t2m_transformer.clip_model.motion = MotionTransformerv2(opt.dataset_name).to(opt.device)
    ...
    # kpt = torch.load(opt.moCLIP, map_location=opt.device)
