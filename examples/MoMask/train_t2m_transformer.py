...
from eval_t2m_trans_res import load_trans_model
...
if __name__ == '__main__':
    ...
    t2m_transformer = load_trans_model(model_opt, which_model='latest_backup.tar', clip_version=clip_version) # latest_backup
    ...
    # t2m_transformer = finetune_model(t2m_transformer)
